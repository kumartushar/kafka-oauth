package com.coupa.security.oauthbearer;
...
public class OauthHttpCalls {
  ...
  private static final String OAUTH_SERVER = (String) getEnvironmentVariables("OAUTH_SERVER", "");
  private static final String OAUTH_TOKEN_ENDPOINT = (String) getEnvironmentVariables("OAUTH_TOKEN_ENDPOINT", "");
  private static final String OAUTH_GRANT_TYPE = (String) getEnvironmentVariables("OAUTH_GRANT_TYPE", "");
  private static final String OAUTH_SCOPE = (String) getEnvironmentVariables("OAUTH_SCOPE", "");
  private static final String OAUTH_AUTHORIZATION = (String) getEnvironmentVariables("OAUTH_AUTHORIZATION", "");
  ...
  public static OauthBearerTokenJwt login(String clientId) {
    ...
    try {
      ...
      //Mount POST data
      String grantType = "grant_type=" + OAUTH_GRANT_TYPE;
      String scope = "scope=" + OAUTH_SCOPE;
      ...
      if(OAUTH_WITH_SSL){
        resp = doHttpsCall(OAUTH_SERVER + OAUTH_TOKEN_ENDPOINT, postDataStr, OAUTH_AUTHORIZATION);
      }else{
        resp = doHttpCall(OAUTH_SERVER + OAUTH_TOKEN_ENDPOINT, postDataStr, OAUTH_AUTHORIZATION);
      }
  ...
  public static OauthBearerTokenJwt introspectBearer(String accessToken){
    ...
    try {
      ...
      if(OAUTH_WITH_SSL){
          resp = doHttpsCall(OAUTH_SERVER + OAUTH_INTROSPECT_ENDPOINT, token, OAUTH_AUTHORIZATION);
      }else{
          resp = doHttpCall(OAUTH_SERVER + OAUTH_INTROSPECT_ENDPOINT, token, OAUTH_AUTHORIZATION);
      }
      if(resp != null){
